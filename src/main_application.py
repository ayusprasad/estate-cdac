...
from src.api.v1_router import router as api_v1_router
from src.database_models.database_connection import create_db_and_tables, engine
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    # Initialize database tables using SQLite
