...
def detect_language(
    ...
    Returns:
        ...
        Falls back to default language on failure.
    """
    default_lang = settings.document.default_language
    threshold = min_confidence or settings.document.langdetect_min_confidence
